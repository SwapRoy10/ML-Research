#!/bin/bash
#SBATCH --job-name=qwen-prompt-atk
#SBATCH --partition=gpu
#SBATCH --gres=gpu:2
#SBATCH --nodelist=dgxt001
#SBATCH --mem=64G
#SBATCH --time=06:00:00
#SBATCH --output=logs/qwen_prompt_attack_%j.out
#SBATCH --error=logs/qwen_prompt_attack_%j.err
...
source .env
set +a
mkdir -p logs "${RESULTS_DIR}/qwen_prompt_attack"
...
lm_eval \
  ...
  --output_path "${RESULTS_DIR}/qwen_prompt_attack" \
  --log_samples
